...
A macro can produce one or more results that want to be returned.
The macro :term:`API` enforces to specify certain information about
these result values.
Here an example of how to define and set the results to return::

...
class PoolChannelTV(TaurusValue):
    ...
    def getDefaultReadWidgetClass(self, returnAll=False):
        ...
        ----------
        returnAll :
            bool) if True, the return value is a list of valid
            classes instead of just one class (Default value = False)

        Returns
        -------
        type
            class or list<class>) the default class  to use for the read
